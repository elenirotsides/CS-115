...
0       read    r1         # Get n
1       jeqzn   r1 20      # if r1 == 0, jump to line 20
2       copy    r5 r1      # sets r5 = r1
3       addn    r5 -1      # decrements r5 by 1
4       jeqzn   r5 25      # if r5 == 0, jump to line 25
5       addn    r5 -1      # decrements r5 by 1 again
6       jeqzn   r5 21      # if r5 == 0, jump to line 21
7       copy    r3 r1      # sets r3 = r1
8       setn    r1 0       # sets r1 = 0
9       write   r1         # prints r1
10      addn    r3 -2      # decrement r3 by 2 (since I print twice)
11      setn    r2 1       # sets r2 = 1
12      write   r2         # print r2
13      copy    r4 r2      # sets r4 = r2
14      add     r2 r1 r2   # r2 = r1 + r2
15      write   r2         # print r2
16      copy    r1 r4      # sets r1 = r4 (old r2 value)
17      addn    r3 -1      # decrements r3 by 1
18      jeqzn   r3 20      # if r3 == 0, jump to line 20
19      jumpn   13         # repeats
20      halt               # stops
21      write   r5         # print r5
22      addn    r5 1       # decrements r5 by 1
23      write   r5         # print r5
24      halt               # stops
25      write   r5         # print r5
26      halt               # stops
"""
